...
export type DeleteTrackMutation = { __typename: "Mutation" } & {
  deleteTrack?: Maybe<
    { __typename: "DeleteTrack" } & Pick<DeleteTrack, "trackId">
  >;
};
...
export type CurrentUserFragment = { __typename: "UserType" } & Pick<
  UserType,
  | "id"
  | "username"
  | "firstName"
...
export type MeQuery = { __typename: "Query" } & {
  me?: Maybe<{ __typename: "UserType" } & CurrentUserFragment>;
};
...
>;
export type CreateTrackMutationResult = Apollo.MutationResult<
  CreateTrackMutation
>;
...
>;
export type DeleteTrackMutationResult = Apollo.MutationResult<
  DeleteTrackMutation
>;
...
export function useSearchTracksQuery(
  ...
  return Apollo.useQuery<SearchTracksQuery, SearchTracksQueryVariables>(
...
export function useSearchTracksLazyQuery(
  ...
  return Apollo.useLazyQuery<SearchTracksQuery, SearchTracksQueryVariables>(
    SearchTracksDocument,
    baseOptions
  );
}
